...
export default function Landing() {
  const data = [
    ...
    },
    {
      label: 'LIÊN HỆ',
      value: 'LIÊN HỆ',
      desc: `${landing_body2_pic1}, ${landing_body2_pic2}`,
    },
  ];
