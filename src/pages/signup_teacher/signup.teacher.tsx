...
import { SignupSectionChip, TeacherSignupLabel, TeacherSignupWarning, TextInputWithLabel, DateTimeInputWithLabel, SelectInputWithLabel, ImageUploader, SuccessfulRegistrationDialog } from "./signup.teacher.child.components"
...
export default function SignupTeacher() {
    ...
    const [isSuccessfulDialogShown, setIsSuccessfulDialogShown] = useState<boolean>()
    ...
    return (
        <div className="my-5 justify-items-center">
            ...
            <SuccessfulRegistrationDialog isOpen={isSuccessfulDialogShown} handleOpen={handleOpen} />
